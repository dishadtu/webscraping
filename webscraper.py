...
print("this is with html tags  ----------------- TITLE  :",title)
...
print("this is without html tags -------------------- H1    :",qwery.text) 
...
# As you can see div element extracted , it also have inner elements
